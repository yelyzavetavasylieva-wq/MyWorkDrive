// DocumentPageTopLeftIcon — Microsoft Fluent System Icons (Regular theme).
...
export function DocumentPageTopLeftIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
