// CellularData1Icon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  20: (<><path d="M16.5 4a.5.5 0 0 1 .5.41V15.5a.5.5 0 0 1-.99.09V4.5c0-.28.22-.5.5-.5m-9 6a.5.5 0 0 1 .5.4v5.1a.5.5 0 0 1-.99.09v-5.1c0-.27.22-.5.5-.5m-3 2a.5.5 0 0 1 .5.4v3.1a.5.5 0 0 1-1 .09v-3.1c0-.27.22-.5.5-.5m6-4a.5.5 0 0 1 .5.4v7.1a.5.5 0 0 1-1 .09v-7.1c0-.27.22-.5.5-.5m3-2a.5.5 0 0 1 .5.41v9.09a.5.5 0 0 1-1 .09V6.5c0-.27.22-.5.5-.5"/></>),
  24: (<><path d="M3.75 17c.38 0 .7.28.74.65l.01.1v1.5a.75.75 0 0 1-1.5.1v-1.6c0-.41.34-.75.75-.75m8-6c.38 0 .7.28.74.65l.01.1v7.5a.75.75 0 0 1-1.5.1v-7.6c0-.41.34-.75.75-.75m4-3c.38 0 .7.28.74.65l.01.1v10.5a.75.75 0 0 1-1.5.1V8.75c0-.41.34-.75.75-.75m4-3c.37 0 .69.28.74.64l.01.1v13.5a.75.75 0 0 1-1.5.12V5.76c0-.42.33-.76.74-.76m-12 9c.38 0 .7.28.74.65l.01.1v4.5a.75.75 0 0 1-1.5.1v-4.6c0-.41.34-.75.75-.75"/></>),
};
const SIZES = [20, 24];
...
export function CellularData1Icon({ size = 20, ...props }) {
  const k = pick(size);
  return (
