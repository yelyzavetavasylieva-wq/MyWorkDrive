// PipelineAddIcon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  20: (<><path d="M2 5.5a1.5 1.5 0 1 1 3 0V6h10v-.5a1.5 1.5 0 0 1 3 0v4.76a6 6 0 0 0-1-.66V5.5a.5.5 0 0 0-1 0v3.7q-.49-.13-1-.18V7H5v6h4.2q-.13.49-.18 1H5v.5a1.5 1.5 0 0 1-3 0zm2 0a.5.5 0 0 0-1 0v9a.5.5 0 0 0 1 0zm15 9a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0m-4-2a.5.5 0 0 0-1 0V14h-1.5a.5.5 0 0 0 0 1H14v1.5a.5.5 0 0 0 1 0V15h1.5a.5.5 0 0 0 0-1H15z"/></>),
};
const SIZES = [20];
...
export function PipelineAddIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
