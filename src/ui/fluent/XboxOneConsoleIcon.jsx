// XboxOneConsoleIcon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  20: (<><path d="M17 6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-1H3a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1zM5 13h12v-1H5zm-2-2h14V7H3zm12.25-3a.75.75 0 1 1 0 1.5.75.75 0 0 1 0-1.5"/></>),
};
const SIZES = [20];
...
export function XboxOneConsoleIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
