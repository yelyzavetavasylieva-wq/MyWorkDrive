// AnimalRabbitOffIcon — Microsoft Fluent System Icons (Regular theme).
...
export function AnimalRabbitOffIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
