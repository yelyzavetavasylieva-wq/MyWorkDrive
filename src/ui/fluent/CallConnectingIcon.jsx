// CallConnectingIcon — Microsoft Fluent System Icons (Regular theme).
...
export function CallConnectingIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
