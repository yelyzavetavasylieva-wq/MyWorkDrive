// PasswordResetIcon — Microsoft Fluent System Icons (Regular theme).
...
export function PasswordResetIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
