// GameControllerTriggerRightIcon — Microsoft Fluent System Icons (Regular theme).
...
export function GameControllerTriggerRightIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
