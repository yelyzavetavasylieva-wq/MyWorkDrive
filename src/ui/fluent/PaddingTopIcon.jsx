// PaddingTopIcon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  20: (<><path d="M3.5 2a.5.5 0 0 0 0 1h1a.5.5 0 0 0 0-1zm3 0a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1zm4 0a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1zm4 0a.5.5 0 0 0 0 1h1a.5.5 0 0 0 0-1zM9.85 4.15a.5.5 0 0 0-.7 0l-4.5 4.5a.5.5 0 1 0 .7.7L9 5.71v9.79a.5.5 0 0 0 1 0V5.7l3.65 3.65a.5.5 0 0 0 .7-.7zM3.5 17a.5.5 0 0 0 0 1h12a.5.5 0 0 0 0-1z"/></>),
  24: (<><path d="M4.5 2.75c0-.41.34-.75.75-.75h.87a.75.75 0 0 1 0 1.5h-.87a.75.75 0 0 1-.75-.75m3.47 0c0-.41.33-.75.75-.75h1.73a.75.75 0 0 1 0 1.5H8.72a.75.75 0 0 1-.75-.75m4.33 0c0-.41.34-.75.75-.75h1.73a.75.75 0 0 1 0 1.5h-1.73a.75.75 0 0 1-.75-.75m4.33 0c0-.41.34-.75.75-.75h.87a.75.75 0 0 1 0 1.5h-.87a.75.75 0 0 1-.75-.75M4.5 21.25c0-.41.34-.75.75-.75h13a.75.75 0 0 1 0 1.5h-13a.75.75 0 0 1-.75-.75m7.78-16.03a.75.75 0 0 0-1.06 0l-5 5a.75.75 0 1 0 1.06 1.06L11 7.56v10.69a.75.75 0 0 0 1.5 0V7.56l3.72 3.72a.75.75 0 1 0 1.06-1.06z"/></>),
};
const SIZES = [20, 24];
...
export function PaddingTopIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
