// CloudDatabaseIcon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  20: (<><path d="M10 3c2.82 0 4.41 1.92 4.65 4.25h.07a3.3 3.3 0 0 1 3.18 2.54q-.26-.16-.53-.27-.36-.16-.79-.27c-.41-.6-1.1-1-1.86-1h-.07a1 1 0 0 1-1-.9C13.45 5.32 12.11 4 10 4S6.55 5.32 6.35 7.35a1 1 0 0 1-1 .9h-.07A2.33 2.33 0 0 0 3 10.62 2.33 2.33 0 0 0 5.28 13H10v1H5.28A3.33 3.33 0 0 1 2 10.62c0-1.8 1.37-3.27 3.1-3.37h.25C5.6 4.9 7.18 3 10 3m7.47 11.28c-.8.47-1.86.72-2.97.72-1.1 0-2.16-.25-2.97-.72q-.27-.15-.53-.36V17c0 1.1 1.57 2 3.5 2s3.5-.9 3.5-2v-3.08q-.26.21-.53.36M14.5 10c-1.93 0-3.5.9-3.5 2s1.57 2 3.5 2 3.5-.9 3.5-2-1.57-2-3.5-2"/></>),
};
const SIZES = [20];
...
export function CloudDatabaseIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
