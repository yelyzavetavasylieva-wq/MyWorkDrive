// GameControllerBumperRightIcon — Microsoft Fluent System Icons (Regular theme).
...
export function GameControllerBumperRightIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
