// IosArrowRtlIcon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  24: (<><path d="m19.7 12-8.49-8.73a.75.75 0 1 1 1.08-1.04l9 9.25c.28.29.28.75 0 1.04l-9 9.25a.75.75 0 1 1-1.08-1.04z"/></>),
};
const SIZES = [24];
...
export function IosArrowRtlIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
