// BatteryCharge4Icon — Microsoft Fluent System Icons (Regular theme).
...
export function BatteryCharge4Icon({ size = 20, ...props }) {
  const k = pick(size);
  return (
