// SettingsSyncIcon — Microsoft Fluent System Icons (Regular theme).
...
export function SettingsSyncIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
