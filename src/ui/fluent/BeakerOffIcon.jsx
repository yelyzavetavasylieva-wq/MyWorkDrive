// BeakerOffIcon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  20: (<><path d="M2.85 2.15a.5.5 0 1 0-.7.7L6.99 7.7v.99a3.5 3.5 0 0 1-.41 1.66l-2.4 4.44A1.5 1.5 0 0 0 5.5 17h9c.5 0 .93-.24 1.2-.6l1.45 1.45a.5.5 0 0 0 .7-.7zm12.12 13.52a.5.5 0 0 1-.47.33h-9a.5.5 0 0 1-.44-.74L6.28 13h6.01zM11.29 12H6.82l.64-1.18a4.5 4.5 0 0 0 .53-2.12zM12 8.68q0 .75.24 1.44l2.3 2.3-1.12-2.08A3.5 3.5 0 0 1 13 8.68V4h1a.5.5 0 0 0 0-1H6a.5.5 0 0 0-.49.4l.61.6H7v.87l1 1V4H12z"/></>),
};
const SIZES = [20];
...
export function BeakerOffIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
