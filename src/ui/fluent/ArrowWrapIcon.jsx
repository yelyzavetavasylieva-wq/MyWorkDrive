// ArrowWrapIcon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  20: (<><path d="M14 4a3 3 0 1 1 0 6H6a2 2 0 1 0 0 4h10.3l-.65-.65a.5.5 0 0 1 .7-.7l1.5 1.5c.2.2.2.5 0 .7l-1.5 1.5a.5.5 0 0 1-.7-.7l.64-.65H6a3 3 0 1 1 0-6h8a2 2 0 1 0 0-4H3.5a.5.5 0 0 1 0-1z"/></>),
};
const SIZES = [20];
...
export function ArrowWrapIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
