// PersonRunningIcon — Microsoft Fluent System Icons (Regular theme).
...
export function PersonRunningIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
