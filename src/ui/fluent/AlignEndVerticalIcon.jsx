// AlignEndVerticalIcon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  20: (<><path d="M6 8a2 2 0 0 0-2 2v2c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2zm-1 2a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1z"/><path d="M2 16.5c0-.28.22-.5.5-.5h15a.5.5 0 0 1 0 1h-15a.5.5 0 0 1-.5-.5"/></>),
};
const SIZES = [20];
...
export function AlignEndVerticalIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
