// PortUsbCIcon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  20: (<><path d="M4.5 10c0-1.1.9-2 2-2h7a2 2 0 1 1 0 4h-7a2 2 0 0 1-2-2m2-1a1 1 0 0 0 0 2h7a1 1 0 1 0 0-2z"/></>),
  24: (<><path d="M16 10.5a1.5 1.5 0 1 1 0 3H8a1.5 1.5 0 1 1 0-3zM16 9H8a3 3 0 1 0 0 6h8a3 3 0 0 0 0-6"/></>),
};
const SIZES = [20, 24];
...
export function PortUsbCIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
