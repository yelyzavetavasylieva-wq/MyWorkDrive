// DividerTallIcon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  16: (<><path d="M7.5 1c.28 0 .5.22.5.5v13a.5.5 0 0 1-1 0v-13c0-.28.22-.5.5-.5"/></>),
  20: (<><path d="M9.5 1c.28 0 .5.22.5.5v17a.5.5 0 0 1-1 0v-17c0-.28.22-.5.5-.5"/></>),
  24: (<><path d="M11.25 2.75v18.5a.75.75 0 0 0 1.5 0V2.75a.75.75 0 0 0-1.5 0"/></>),
};
...
export function DividerTallIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
