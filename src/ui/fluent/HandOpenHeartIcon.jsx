// HandOpenHeartIcon — Microsoft Fluent System Icons (Regular theme).
...
export function HandOpenHeartIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
