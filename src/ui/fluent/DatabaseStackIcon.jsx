// DatabaseStackIcon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  16: (<><path d="M8 1C5.15 1 3 2.08 3 3.5v9C3 13.93 5.15 15 8 15s5-1.07 5-2.5v-9C13 2.08 10.85 1 8 1m0 1c2.44 0 4 .89 4 1.5S10.44 5 8 5s-4-.89-4-1.5S5.56 2 8 2m0 12c-2.44 0-4-.89-4-1.5V9.54c.9.59 2.33.96 4 .96a7.5 7.5 0 0 0 4-.96v2.96c0 .61-1.56 1.5-4 1.5m0-4.5c-2.44 0-4-.89-4-1.5V5.02A7.4 7.4 0 0 0 8 6a7.4 7.4 0 0 0 4-.98V8c0 .61-1.56 1.5-4 1.5"/></>),
};
const SIZES = [16];
...
export function DatabaseStackIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
