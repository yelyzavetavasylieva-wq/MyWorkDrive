// DocumentPageNumberIcon — Microsoft Fluent System Icons (Regular theme).
...
export function DocumentPageNumberIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
