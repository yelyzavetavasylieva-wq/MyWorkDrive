// TextProofingToolsAbcIcon — Microsoft Fluent System Icons (Regular theme).
...
export function TextProofingToolsAbcIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
