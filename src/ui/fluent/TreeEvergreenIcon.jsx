// TreeEvergreenIcon — Microsoft Fluent System Icons (Regular theme).
...
export function TreeEvergreenIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
