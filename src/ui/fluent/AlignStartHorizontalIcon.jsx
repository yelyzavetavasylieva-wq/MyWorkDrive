// AlignStartHorizontalIcon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  20: (<><path d="M3.5 18a.5.5 0 0 1-.5-.5v-15a.5.5 0 0 1 1 0v15a.5.5 0 0 1-.5.5"/><path d="M8 4a2 2 0 0 0-2 2v8c0 1.1.9 2 2 2h2a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zM7 6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1z"/></>),
};
const SIZES = [20];
...
export function AlignStartHorizontalIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
