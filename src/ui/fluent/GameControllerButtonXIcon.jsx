// GameControllerButtonXIcon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  20: (<><path d="M10 2a8 8 0 1 1 0 16 8 8 0 0 1 0-16m0 1a7 7 0 1 0 0 14 7 7 0 0 0 0-14m2.65 3.65a.5.5 0 1 1 .7.7L10.71 10l2.64 2.65a.5.5 0 1 1-.7.7L10 10.71l-2.65 2.64a.5.5 0 1 1-.7-.7L9.29 10 6.65 7.35a.5.5 0 1 1 .7-.7L10 9.29z"/></>),
};
const SIZES = [20];
...
export function GameControllerButtonXIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
