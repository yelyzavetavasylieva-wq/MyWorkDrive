// SprayCanIcon — Microsoft Fluent System Icons (Regular theme).
...
const C = {
  16: (<><path d="M9.5 4a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1M11 2.5a.5.5 0 1 1 1 0 .5.5 0 0 1-1 0m0 2a.5.5 0 1 1 1 0 .5.5 0 0 1-1 0m2-3a.5.5 0 1 1 1 0 .5.5 0 0 1-1 0m0 2a.5.5 0 1 1 1 0 .5.5 0 0 1-1 0m0 2a.5.5 0 1 1 1 0 .5.5 0 0 1-1 0m-3.03.87.02.07v.02l.01.04v6.75c0 .97-.78 1.75-1.75 1.75h-3.5C3.78 15 3 14.22 3 13.25V6.46l.01-.02.02-.07a1 1 0 0 1 .12-.22L5 4.29V2.5c0-.28.22-.5.5-.5h2c.28 0 .5.22.5.5v1.8l1.85 1.85q.09.1.13.22M7 3H6v1h1zm.3 2H5.7l-1 1h3.6zm.95 9c.41 0 .75-.34.75-.75V7H4v6.25c0 .41.34.75.75.75z"/></>),
};
const SIZES = [16];
...
export function SprayCanIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
