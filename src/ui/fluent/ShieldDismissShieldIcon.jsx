// ShieldDismissShieldIcon — Microsoft Fluent System Icons (Regular theme).
...
export function ShieldDismissShieldIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
