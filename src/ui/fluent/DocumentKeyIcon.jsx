// DocumentKeyIcon — Microsoft Fluent System Icons (Regular theme).
...
export function DocumentKeyIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
