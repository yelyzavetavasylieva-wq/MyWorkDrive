// GlanceHorizontalSparkleIcon — Microsoft Fluent System Icons (Regular theme).
...
export function GlanceHorizontalSparkleIcon({ size = 20, ...props }) {
  const k = pick(size);
  return (
